...
insert into book (id, author_id, genre_id, bookName) values (3, 8, 5, 'Разумный инвестор. Полное руководство по стоимостному инвестированию');
insert into book (id, author_id, genre_id, bookName) values (4, 3, 2, 'Любовь во время чумы');
insert into book (id, author_id, genre_id, bookName) values (5, 5, 3, 'Ведьмак');
insert into book (id, author_id, genre_id, bookName) values (6, 6, 3, 'Королевская битва');
insert into book (id, author_id, genre_id, bookName) values (7, 7, 2, 'Шагреневая кожа');
insert into book (id, author_id, genre_id, bookName) values (8, 9, 1, 'Судный день');
insert into book (id, author_id, genre_id, bookName) values (9, 1, 3, 'Гарри Поттер');
